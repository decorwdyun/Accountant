...
public partial class ConfigWindow
{
    private void DrawConfigTab()
    {
        ...
        ImGuiRaii.ConfigCheckmark("忽略室内作物", Accountant.Config.IgnoreIndoorPlants, IgnoreIndoorPlants);
        ImGuiRaii.ConfigCheckmark("根据种子进行分组",  Accountant.Config.OrderByCrop, OrderByCrop);
